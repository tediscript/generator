...
class Kontak_importer_model extends Model{
   
    var $table_name = 'kontak_importer';

    function Kontak_importer_model(){
        parent::Model();
    }

    function insert($kontak_importer){
        $this->db->insert($this->table_name, $kontak_importer);
    }

    function update($id, $kontak_importer){
        $this->db->where('kontak_id', $id);
        $this->db->update($this->table_name, $kontak_importer);
    }
